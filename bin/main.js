...
const enhanceErrorMessages = require('../src/util/enhanceErrorMessages.js')
...
program
  ...
  .action((templateName, projectName, cmd) => {
    ...
    require('../src/easy-create')(lowercase(templateName), projectName)
  })
...
program
  ...
  .action((templateName, gitRepoAddress, cmd) => {
    validateArgsLen(process.argv.length, 5)
    require('../src/add-template')(lowercase(templateName), gitRepoAddress)
  })
...
program
  ...
  .action((templateName, cmd) => {
    ...
    require('../src/delete-template')(templateName)
  })
